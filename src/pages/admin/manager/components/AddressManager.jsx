            ...
            <div className="flex justify-between items-start">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="text-sm text-(--color-primary) hover:text-(--color-hover-primary) cursor-pointer"
                >
                  Edit
                </button>
                <button
            ...
            <div className="p-6">
              ...
              <div className="flex gap-3 justify-end mt-6">
                <button
                  ...
                  className="px-4 py-2 border bg-red-500 text-black border-gray-300 rounded-lg hover:bg-gray-50 cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="px-4 py-2 bg-(--color-primary) border border-(--color-primary) hover:border-(--color-primary-hover) text-white hover:text-(--text-default) rounded-lg hover:bg-(--color-hover-primary) cursor-pointer"
                >
