...
const Users = () => {
  ...
  const filteredUsers = Users.filter((User) => {
    ...
    if (filters.dateRange.start && User.joinedDate) {
      const joinedDate = new Date(User.joinedDate);
      const startDate = new Date(filters.dateRange.start);
      matchesDate = joinedDate >= startDate;
    }
    if (filters.dateRange.end && matchesDate && User.joinedDate) {
      const joinedDate = new Date(User.joinedDate);
    ...
    const matchesOrders =
      (!filters.minOrders ||
        User.totalOrders >= parseInt(filters.minOrders)) &&
      (!filters.maxOrders ||
        User.totalOrders <= parseInt(filters.maxOrders));
